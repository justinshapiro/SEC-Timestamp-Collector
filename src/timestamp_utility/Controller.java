...
public class Controller implements Initializable {
    ...
    @FXML private TextField output_file_box = new TextField();
    @FXML private TextArea cik_box = new TextArea();
    @FXML private TextArea filing_type_box = new TextArea();
    @FXML private TextArea date_box = new TextArea();
    @FXML private Button browse_button = new Button();
    @FXML private Button start_button = new Button();
    @FXML private Label status_indicator = new Label();
    @FXML private Hyperlink view_result = new Hyperlink();
            ...
            if (output_file_box.getText().trim().isEmpty()) {
                ...
                new Thread(new Task<Void>() {
                    ...
                    protected Void call() throws Exception {
                        ...
                        collector_agent.init(output_file_box.getText(), data);
